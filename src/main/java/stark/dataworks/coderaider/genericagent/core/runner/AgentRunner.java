...
import stark.dataworks.coderaider.genericagent.core.approval.ToolApprovalRequest;
import stark.dataworks.coderaider.genericagent.core.agent.AgentChatClient;
import stark.dataworks.coderaider.genericagent.core.context.IContextBuilder;
import stark.dataworks.coderaider.genericagent.core.exceptions.GuardrailTripwireException;
import stark.dataworks.coderaider.genericagent.core.exceptions.HandoffDeniedException;
import stark.dataworks.coderaider.genericagent.core.exceptions.MaxTurnsExceededException;
import stark.dataworks.coderaider.genericagent.core.exceptions.ModelInvocationException;
import stark.dataworks.coderaider.genericagent.core.exceptions.ToolExecutionFailureException;
...
import stark.dataworks.coderaider.genericagent.core.handoff.Handoff;
...
import stark.dataworks.coderaider.genericagent.core.output.OutputSchemaMapper;
...
import stark.dataworks.coderaider.genericagent.core.tracing.ITraceProvider;
import stark.dataworks.coderaider.genericagent.core.tracing.ITraceSpan;
...
public class AgentRunner
{
    ...
    public static final class Builder
    {
        ...
        private IContextBuilder contextBuilder = new stark.dataworks.coderaider.genericagent.core.context.DefaultContextBuilder();
        ...
        private ISessionStore sessionStore = new stark.dataworks.coderaider.genericagent.core.session.InMemorySessionStore();
        private ITraceProvider traceProvider = new stark.dataworks.coderaider.genericagent.core.tracing.NoopTraceProvider();
        private IToolApprovalPolicy toolApprovalPolicy = new stark.dataworks.coderaider.genericagent.core.approval.AllowAllToolApprovalPolicy();
